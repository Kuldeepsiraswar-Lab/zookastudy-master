...
public class Defense_Article extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    public WebView mWebView;
    private SwipeRefreshLayout swipeRefreshLayout;
    public Defense_Article() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mWebView.loadUrl("https://study.zookaresult.in/defense-article/");
