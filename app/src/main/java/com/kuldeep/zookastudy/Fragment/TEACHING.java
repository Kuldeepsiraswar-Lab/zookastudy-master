...
import com.kuldeep.zookastudy.SubjectsTab.Pedogogy;
...
import com.kuldeep.zookastudy.SubjectsTab.Teaching_Article;
import com.kuldeep.zookastudy.SubjectsTab.Teaching_Home;
...
public class TEACHING extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.teaching, container, false);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Teaching_Home(), "Latest-Update");
        adapter.addFragment(new Teaching_Article(), "Articles");
        ...
        adapter.addFragment(new Pedogogy(), "Pedogogy");
