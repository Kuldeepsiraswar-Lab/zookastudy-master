...
public class SSC extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.ssc, null);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Scc_Home(), "Latest-Update");
        adapter.addFragment(new SSC_Article(), "Articles");
